...
async function sendLoginLink(e){
 ...
 const result=document.querySelector('#loginResult');if(result)result.innerHTML='<div class="notice success">Code sent. Check your email and enter the eight digits above.</div>';
}
